...
import { imageUrl } from './src/storefront/imageUrl.js'
globalThis.window = { location: { origin: 'https://admin.gingtto.store' } }

test('known product image uses bounded thumbnail size', () => {
  assert.equal(imageUrl('https://img.smawell.shop/uploads/a.jpg', 160), 'https://admin.gingtto.store/uploads/a.jpg?w=160')
